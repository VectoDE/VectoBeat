  ...
  <tr>
    ...
    <td width="33%">
      ...
      <ul>
        ...
        <li>Vercel Speed Insights & Web Analytics</li>
      </ul>
    </td>
    <td width="33%">
      <h3>🧩 Extensibility</h3>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Randomised search results, queue autosync, manual scrubbing, replay, loop modes, volume control, auto-resume protection, Redis-backed playlists, history-aware autoplay</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>/timeshift</code></td><td>Move to a timestamp within the current track (mm:ss).</td></tr>
